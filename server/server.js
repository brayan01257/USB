...
const client = new Client({
    ...
    database: 'gdb_3041',       // Nombre de la base de datos
...
// Desplegar en un servicio local a través del puerto 3041
app.listen(3045, () => {
    console.log('Servidor ejecutándose en http://localhost:3045');
});